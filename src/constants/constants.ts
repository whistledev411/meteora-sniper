 ...
 * New code should use the config service (config/config.service.ts) instead.
 */
...
// Program IDs (kept for backward compatibility)
...
// Legacy connection (kept for backward compatibility)
